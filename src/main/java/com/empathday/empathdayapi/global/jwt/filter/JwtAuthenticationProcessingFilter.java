package com.empathday.empathdayapi.global.jwt.filter;

import com.empathday.empathdayapi.domain.user.User;
import com.empathday.empathdayapi.global.jwt.service.JwtService;
import com.empathday.empathdayapi.global.jwt.util.PasswordUtil;
...
public class JwtAuthenticationProcessingFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        // -> RefreshToken이 없거나 유효하지 않다면(DB에 저장된 RefreshToken 과 다르다면) null을 반환
